...
public class DepartmentController extends HttpServlet {
	...
	/*
	 * 서버 요청시 1. URL(ip:port/경로) 2. 메서드 형식 1)GET * 단순 요청 시 * 파라미터가 주소창에 노출(파라미터가
	 * Header에 담김) * 작은 용량을 보낼 때 사용 2)POST * 보안이 요구 되는 요청시 * 파라미터가 주소창에 노출이 되지 않음!
	 * => 파라미터가 Body에 담긴다. * 큰 용량을 보낼 대 사용
	 * 
	 * 3. 메서드 결정 1) 주소창에 URL 직접 입력 => GET 2) a 태그 사용 => GET
	 */
